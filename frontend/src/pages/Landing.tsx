...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-600 font-sans selection:bg-stone-200">
      {/* Navbar */}
      <nav className="fixed w-full z-50 bg-white/80 backdrop-blur-md border-b border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden p-2 text-stone-500 hover:text-stone-900 hover:bg-stone-100 rounded-md transition-colors"
            ...
            >
              <div className="px-6 py-6 space-y-4 flex flex-col">
                ...
                <Link
                  to="/register"
                  onClick={() => setIsMenuOpen(false)}
                  className="block w-full text-center px-4 py-3 text-base font-bold text-white bg-stone-900 rounded-lg shadow-lg shadow-stone-900/20"
                >
                  Get Started
                </Link>
              </div>
      ...
      {/* Hero Section */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 md:pt-40 md:pb-32 flex flex-col items-center gap-12">
        {/* Top: The Pitch (Centered) */}
        <div className="space-y-8 relative z-10 text-center max-w-3xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-stone-200 border border-stone-300 text-stone-700 text-[10px] sm:text-xs font-semibold uppercase tracking-wide mb-6">
              <span className="w-2 h-2 rounded-full bg-stone-900 animate-pulse"></span>
              No Backend Required
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold text-stone-900 tracking-tight leading-[1.1] sm:leading-[1.15]">
              Collect Leads from your{" "}
              <span className="text-stone-500">Static Site.</span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-stone-500 max-w-2xl mx-auto leading-relaxed mt-6">
          ...
          >
            <Link
              to="/register"
              className="px-8 py-4 bg-stone-900 hover:bg-stone-800 text-white font-bold rounded-xl transition-all shadow-lg shadow-stone-900/25 flex items-center justify-center gap-2 group w-full sm:w-auto"
            >
              Start for Free
            ...
            <a
              href="#docs"
              className="px-8 py-4 bg-white border border-stone-200 hover:border-stone-400 text-stone-600 font-semibold rounded-xl transition-all flex items-center justify-center gap-2 w-full sm:w-auto"
            >
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm text-stone-500 pt-4">
            <div className="flex items-center gap-2">
        ...
        {/* Bottom: The Code Visualization (Centered) */}
        <motion.div
        ...
        >
          {/* Background Glow */}
          <div className="absolute -inset-1 bg-stone-200 rounded-2xl blur-3xl opacity-40"></div>

          {/* Code Window */}
          <div className="relative bg-stone-900 border border-stone-800 rounded-2xl shadow-2xl overflow-hidden text-left">
            ...
            <div className="bg-stone-950/50 px-4 sm:px-6 py-3 border-t border-stone-800 flex items-center justify-between">
              <span className="text-[10px] sm:text-xs text-stone-500">
                POST /send-email
              </span>
              <span className="text-[10px] sm:text-xs text-emerald-400 font-mono">
                200 OK
              </span>
            </div>
          </div>
          ...
          <motion.div
            ...
            className="absolute -top-6 -right-6 bg-white border border-stone-200 p-4 rounded-xl shadow-xl hidden lg:block"
          >
      ...
      <section
        id="features"
        className="py-16 md:py-24 bg-stone-100 border-t border-stone-200 w-full"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 text-center md:text-left">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-stone-500 text-sm max-w-md mx-auto md:mx-0 leading-relaxed">
          ...
          {/* Bottom Bar */}
          <div className="pt-8 border-t border-stone-200 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
